...
def build_default_pid(joint_names=DEFAULT_JOINTS) -> JointPID:
    ...
    gains = {
        "shoulder_pan":  PIDGains(kp=55.0, ki=0.0, kd=4, i_limit=2.0, tau_limit=8.0),
        "shoulder_lift": PIDGains(kp=30.0, ki=0.0, kd=2, i_limit=2.0, tau_limit=18.0),
        "elbow_flex":    PIDGains(kp=25.0, ki=0.0, kd=1, i_limit=2.0, tau_limit=15.0),
        "wrist_flex":    PIDGains(kp=15.0, ki=0.0, kd=1, i_limit=2.0, tau_limit=6.0),
        "wrist_roll":    PIDGains(kp=10.0, ki=0.0, kd=1.6, i_limit=2.0, tau_limit=3.0),
    }
